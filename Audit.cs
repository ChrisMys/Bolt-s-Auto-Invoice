...
namespace FinalProjectCSharp
{
    public partial class Audit : Form
    {
        ...
        // enteries within our database. Using a TRY-CATCH we will also check for any errors we may have connecting to our database.
        private DataTable GetCompletedInvoices()
        {
            ...
            using (SqlConnection con = new SqlConnection(connString))
            {
                try
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT INV.invoice_number 'Invoice Number', INV.date_saved 'Date', INV.first_name 'First Name', INV.last_name 'Last Name', " +
                                                            "SUM(TPL.hst) 'HST', SUM(TPL.total) 'Total' " +
